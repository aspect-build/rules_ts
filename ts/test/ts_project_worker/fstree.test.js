...
calls = [];
let watcher1 = tree.watchFile("inputs/1.js", function test(p) {calls.push("watcher1")});
let watcher2 = tree.watchFile("inputs/1.js", function test2(p) {calls.push("watcher2")});
let watcher3 = tree.watchFile("inputs/1.js", function test3(p) {calls.push("watcher3")});
let watcher4 = tree.watchFile("inputs/1.js", function test4(p) {calls.push("watcher4")});
watcher1();
watcher2();
createFile("inputs/1.js");
tree.add("inputs/1.js");
