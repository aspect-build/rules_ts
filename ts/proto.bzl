"User-facing public API for registering TypeScript gRPC protoc plugin toolchains."
...
# - Allow users to choose other plugins. Let's do it!
...
#         gen_connect_es: [deprecated] whether protoc_gen_connect_es should generate grpc services, and therefore `*_connect.{js,d.ts}` should be written.
