...
module "aspect_workflows" {
  ...
  source = "https://s3.us-east-2.amazonaws.com/static.aspect.build/aspect/5.9.3/terraform-aws-aspect-workflows.zip"
...
module "aspect_workflows_grafana_dashboards" {
  ...
  source = "https://s3.us-east-2.amazonaws.com/static.aspect.build/aspect/5.9.3/terraform-aws-aspect-workflows.zip//monitoring/dashboards"
