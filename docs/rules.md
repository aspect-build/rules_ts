...
| <a id="ts_project_rule-assets"></a>assets |  Files which are needed by a downstraam build step such as a bundler.         See more details on the <code>assets</code> parameter of the <code>ts_project</code> macro.   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional | <code>[]</code> |
