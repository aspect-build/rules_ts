// @generated by protoc-gen-es v2.11.0 with parameter "keep_empty_files=true,target=js+dts,import_extension=js"
...
import type { Empty as Empty$1 } from "./stripping/s_pb.js";
...
export declare type LogMessage = Message<"logger.LogMessage"> & {
  ...
  /**
   * @generated from field: proto_grpc.stripping.Empty empty = 5;
   */
  empty?: Empty$1;
};
